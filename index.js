...
const questions = [
  ...
  },
  {
    ...
    type: "input",
    message:
      "Take a moment to Credit the authors or document sites used for this project.",
  },
  {
    name: "github",
    type: "input",
    message:
      "Please provide your GitHub name for people to reach out too for any questions.",
  },
  {
    name: "email",
    type: "input",
    message:
      "Please provide an email for anyone to reachout to for any questions.",
  },
  {
    name: "license",
    type: "list",
